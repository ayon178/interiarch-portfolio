...
export default function DesignPhilosophy() {
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Typography
        variant="h4"
        sx={{ fontWeight: 'bold', textAlign: 'left', marginBottom: 4 }}
      >
        Why Us
      </Typography>
      ...
      <Grid container spacing={4} sx={{ mb: 6 }} alignItems="center">
        ...
        <Grid item xs={12} md={6}>
          ...
          <Typography variant="body1" paragraph>
            ...
            enhances the functionality of inner environment. Thoughtfully planed
            layouts align with intended purposes, fostering productivity and
            satisfaction.Making spaces more conductive to their unique
            activities. Also making the best use of available space as in urban
            area empty space is limited.
          </Typography>
          {/* <Typography variant="body1" paragraph>
      ...
      <Grid container spacing={4} sx={{ mt: 6, mb: 3 }} alignItems="center">
        ...
        <Grid item xs={12} md={6}>
          ...
          <Typography variant="body1" paragraph>
            ...
            nterior design is not only for artistic beauty or better functions,
            it can highly increase the property value of any real estate.
            Quality materials & appealing design add value to the property and
            make it more suitable choice to buyers by increasing it&apos;s
            usability.
          </Typography>
          {/* <Typography variant="body1" paragraph>
            We craft spaces that are both visually striking and functional,
